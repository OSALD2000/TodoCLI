...
exports.addTodoGitIgnore = void 0;
var fs = __importStar(require("fs"));
var path_1 = __importDefault(require("path"));
var addTodoGitIgnore = function (path_parmeter) {
    ...
    if (fs.existsSync(git_path)) {
        ...
        if (fs.existsSync(gitignor_path)) {
            try {
                ...
                if (lines.find(function (ignored) { return ignored.trim() === ".todo"; })) {
                    return true;
                }
                else {
                    lines.push(".todo");
        ...
        return (0, exports.addTodoGitIgnore)(path_1.default.join(path_parmeter, ".."));
    }
};
exports.addTodoGitIgnore = addTodoGitIgnore;
